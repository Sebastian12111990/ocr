...
CATALOGO: list[Etapa] = [
    ...
    Etapa(
        ...
        orden_fijo=6,
        parametros=[
            Parametro(nombre="modo_recuperacion", etiqueta="Recuperación de contornos",
                       tipo="enum", defecto="RETR_LIST",
                       opciones=["RETR_EXTERNAL", "RETR_LIST", "RETR_CCOMP", "RETR_TREE"]),
            Parametro(nombre="metodo_aproximacion", etiqueta="Aproximación de contornos",
                       tipo="enum", defecto="CHAIN_APPROX_SIMPLE",
                       opciones=[
            ...
            Parametro(nombre="rectificar_candidatos", etiqueta="Poner candidatos de frente",
                       tipo="boolean", defecto=False),
